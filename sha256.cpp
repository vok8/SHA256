...
// Mostly all Variable/Function Names, are similar as described in the Pseudo-Code, on NIST Website.
// - https://csrc.nist.gov/csrc/media/publications/fips/180/4/final/documents/fips180-4-draft-aug2014.pdf

// Good & Trusted Sources for Understanding, what's going on in the implementation of the algorithm:
// - https://en.wikipedia.org/wiki/SHA-2 (Pseudo-Code is very well written.)
// - http://csrc.nist.gov/publications/fips/fips180-4/fips-180-4.pdf

// This algorithm will work for all strings, having length <(2^64)
...
int32_t main()
{
    ...
    // Get the text, to be hashed, from the User
    cout<<"\n--> Enter the Text, to find its SHA-256 Hash Value: ";
    string s;
    getline(cin,s);
    ...
    string digest_or_finalhash=process_hash(M,H,k);

    // Output the Hash Value of Input String, computed using SHA-256 Algorithm, in HexaDecimal Format
    cout<<"\n** The Corresponding Hash Value of the Input String (Text) is: "<<digest_or_finalhash<<"\n\n";
    return 0;
}
